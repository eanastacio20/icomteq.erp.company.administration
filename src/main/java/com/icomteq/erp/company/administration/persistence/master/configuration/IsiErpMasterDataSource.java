package com.icomteq.erp.company.administration.persistence.master.configuration;
...
@EnableJpaRepositories(entityManagerFactoryRef = "entityManagerFactory", basePackages = "com.icomteq.erp.company.administration.persistence.master", transactionManagerRef = "transactionManager")
public class IsiErpMasterDataSource {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
		...
		em.setPackagesToScan(new String[] { "com.icomteq.erp.company.administration.persistence.master" });
